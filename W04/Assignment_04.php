...
<form action="" method="post">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $cost = $_POST['cost'] ?? '';
        $price = $_POST['price'] ?? '';
        echo "<h4>ข้อมูลสินค้า:</h4>";
        echo "<table border='0' cellpadding='5' cellspacing='0' style='border-collapse: collapse; width: 25%;text-align: left;'>";
        echo "<tr><td>รหัสสินค้า</td><td>$product_id</td></tr>";
        echo "<tr><td>ชื่อสินค้า</td><td>$product_name</td></tr>";
        echo "<tr><td>ขนาด</td><td>$size</td></tr>";
        echo "<tr><td>จํานวนสินค้า</td><td>$quantity</td></tr>";
        echo "<tr><td>หน่วยนับ</td><td>$unit</td></tr>";
